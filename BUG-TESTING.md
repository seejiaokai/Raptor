...
| **#368** | Leave War: the on-grid Rearrange bar (Auto-sort / Done) now paints at once on iPhone instead of waiting for a touch — its own compositor layer, one CSS line | ⬜ — owner to confirm on his iPhone against the preview (not reproducible here: no WebKit) |
