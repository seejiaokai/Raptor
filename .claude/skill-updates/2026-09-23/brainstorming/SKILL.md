...
**When the companion cannot open a browser** (a remote or phone session), draw the options on the real running app instead: load the real build, reach the real state by real actions, inject the proposed change into the live page, screenshot it at the widths the app ships, and SEND the images.
