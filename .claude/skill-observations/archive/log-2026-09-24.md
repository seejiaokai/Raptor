...
**Status:** ACTIONED (2026-09-24) — filed as backlog item `[BG-CWD-GUARD]` in OUTSTANDING.md — a structural fix (a hook or a root script), not a guide change; the 23 Sep review left it open for that reason (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-01
...
**Status:** ACTIONED (2026-09-24) — Applied to raptor-port/docs/bug-check-order.md §6 (a new floating surface: every surface it opens over, and an elementFromPoint test on each) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to verification-before-completion: Common Failures row "removed everywhere" (sweep for what identifies; name what the sweep cannot read) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
**Session context:** [ALL-AVAIL-WINDOW] build + a repo-privacy check, Raptor
...
**Status:** ACTIONED (2026-09-24) — Applied to verification-before-completion: Common Failures row "clean / nothing found" (the verdict states its scope) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
**Session context:** [ALL-AVAIL-WINDOW] build + a repo-privacy check, Raptor
...
**Status:** ACTIONED (2026-09-24) — Applied to systematic-debugging: the flaky-check questions (a test's leftovers can be the product's bug) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to session-handoff Step 3 (condense this chat's own scaffolding, its own docs-only commit — D69) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to session-handoff Rule 9 (the opening line is sendable unchanged — no choice slot inside it) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to verification-before-completion "Long check runs": a gate chained into a commit (its pipe-eats-the-verdict half was already in the Common Failures row and raptor-port/CLAUDE.md §Token discipline) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to systematic-debugging/condition-based-waiting.md "Before you pace a test" (replay at human pace first) + a pointer in the SKILL.md flaky questions (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to systematic-debugging/condition-based-waiting.md "Before you pace a test" (make the CI's slowness reproducible; prove the fix at it) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to systematic-debugging/condition-based-waiting.md Common Mistakes (waiting on a proxy) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to systematic-debugging/condition-based-waiting.md Common Mistakes (a symmetric empty read is a false pass) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to systematic-debugging Phase 1 step 3 (a fresh checkout inherits the machine's defaults) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — already reflected: session-handoff Step 1 ("check `gh run list` first, and push the handoff only when no run is going", D151) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to systematic-debugging Phase 1 step 2 (a one-frame defect: sample per frame, pin in the same task); its test half in test-driven-development Verify RED (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to systematic-debugging Red Flags (identical before and after: run the check that tells the two explanations apart first) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to test-driven-development Verify RED (a red-first test green on the old code: find the second cure in the scenario) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to machine-local memory: a new feedback note on writing setup steps he carries out himself (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to raptor-port/docs/gates-and-deploy.md §The checks run on HIS PC (why the folder's permissions mattered: every local account, the tools' own included) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to systematic-debugging Phase 1 step 3 (a service cannot answer a prompt); the concrete fix is already in `.github/workflows/deploy.yml` (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to raptor-port/docs/bug-check-order.md §7.2 (the driver moves the view with the surface's own gesture; a failed gesture is looked at on its picture first) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to raptor-port/docs/bug-check-order.md §6 (a wording ruling or a writer fix gets its own small roll-call; the fix shares one body) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to raptor-port/docs/bug-check-order.md §4, beside D16 (nobody rebuilds the build walkers are served; the host typechecks and unit-tests meanwhile) — its "one shared preview" half NOT applied: D16's recorded recipe gives each walker its own port, and only he can narrow that (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to raptor-port/docs/bug-check-order.md §5 (the re-walk: walk scripts assert the right behaviour, re-walk into a second folder, read FAILs against the new flow) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to raptor-port/docs/bug-check-order.md §8 (a ruling's "as it is today" half is pinned by a test before the new half is built) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to raptor-port/docs/bug-check-order.md §7.2 (walk a SHORT screen too; measure every edge-docked control) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to raptor-port/docs/bug-check-order.md §5 (the surface's own suite after EACH fix round; a closed door's hints) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to raptor-port/docs/bug-check-order.md §7.8 (a gesture step asserts what the person sees) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-23
...
**Status:** ACTIONED (2026-09-24) — Applied to test-driven-development Verify RED (read the red; assert each case's premise; identify by id, not a count) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-24
...
**Status:** ACTIONED (2026-09-24) — Applied to verification-before-completion/browser-checks.md Measure, Don't Estimate (across a mode switch, measure after the first frame, relative to the moved view) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-24
...
**Status:** ACTIONED (2026-09-24) — Applied to raptor-port/docs/bug-check-order.md §7.9 (where engines deliver events differently, replay the other engine's sequence; name what only a real device proves) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-24
...
**Status:** ACTIONED (2026-09-24) — Applied to raptor-port/docs/gates-and-deploy.md §Now (an intermittent gate stop gets evidence and a filed item before its one re-run; D84's known family keeps its own rule) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-24
...
**Status:** ACTIONED (2026-09-24) — Applied to raptor-port/docs/bug-check-order.md §7.7 (change role in place; never sign in again mid-fixture on a fresh demo world) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-24
...
**Status:** ACTIONED (2026-09-24) — Applied to verification-before-completion/browser-checks.md Measure, Don't Estimate (count line positions, not rects) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-24
...
**Status:** ACTIONED (2026-09-24) — Applied to machine-local memory `astra-codex-cli-available.md` (a brief points reviewers at the live files; a mid-review ruling is folded in, not restarted) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-24
...
**Status:** ACTIONED (2026-09-24) — Applied to machine-local memory `prefer-codex-for-bug-checks-fable-scarce.md` (a reviewer's thinking level is a launch setting: `--effort high` on every runner call) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-24
...
**Status:** ACTIONED (2026-09-24) — already reflected: `.claude/rules/doc-structure.md` §When it leaves (`backlog-archive.mjs --move`, `docsize.mjs --moves`) and `raptor-port/docs/doc-budget.md` (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-24
...
**Status:** ACTIONED (2026-09-24) — Applied to writing-plans Task Right-Sizing (a migration of shared records: the checks come first and gate every move) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-24
...
**Status:** ACTIONED (2026-09-24) — Applied to session-handoff Step 3 (before an item leaves, walk every deliverable it ever named) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-24
...
**Status:** ACTIONED (2026-09-24) — Applied to task-observer Numbering discipline rule 4 (prove the cross-branch check on the current branch first; `MSYS_NO_PATHCONV=1` on Git Bash) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-24
...
**Status:** ACTIONED (2026-09-24) — Applied to machine-local memory `astra-codex-cli-available.md` (a brief to the other provider names the area rules files; the rule itself is D140, always loaded) (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-24
...
**Status:** ACTIONED (2026-09-24) — Applied to verification-before-completion Common Failures row (a green run is evidence for its own environment); its fault-injection half in test-driven-development Verify RED (weekly review 24 Sep 26, owner-approved)
**Date:** 2026-09-24
