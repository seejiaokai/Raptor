...
**Status:** ACTIONED (2026-09-23) — Applied to requesting-code-review + receiving-code-review: shared-state checklist, line-ending check, finding/diagnosis/fix, two-of-a-kind, proof for "can't happen" (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-08-17
...
**Status:** ACTIONED (2026-09-23) — Applied to verification-before-completion: Common Failures rows / long-run pattern / browser-checks.md (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-08-17
...
**Status:** DECLINED (2026-09-23) — a one-off CSS fact (a table header cannot sit mid-table); too narrow for a guide (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-08-18
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/docs/performance.md §B Scroll and motion; nothing to change (weekly review 23 Sep 26)
**Date:** 2026-08-19
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/docs/ui-contracts.md (in-time lines); nothing to change (weekly review 23 Sep 26)
**Date:** 2026-08-21
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/CLAUDE.md §Rules-engine robustness doctrine; nothing to change (weekly review 23 Sep 26)
**Date:** 2026-08-21
...
**Status:** ACTIONED (2026-09-23) — Applied to test-driven-development: Verify RED/GREEN additions and writing-good-tests.md (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-08-21
...
**Status:** ACTIONED (2026-09-23) — Applied to brainstorming: visual-first rounds, enumerate "every", layered rules, trap hunt, mock-on-the-real-app fallback (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-08-21
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/CLAUDE.md §Build & verify (stop a server by its port); nothing to change (weekly review 23 Sep 26)
**Date:** 2026-08-21
...
**Status:** ACTIONED (2026-09-23) — Applied to dispatching-parallel-agents: Common Mistakes pairs + "When Agents Share the Working Tree or the Machine" (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-08-22
...
**Status:** ACTIONED (2026-09-23) — Applied to subagent-driven-development: SKILL.md, implementer/task-reviewer prompts, scripts/task-brief (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-08-23
...
**Status:** DECLINED (2026-09-23) — a quirk of one GitHub listing tool; too narrow for a guide (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-08-24
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/docs/ui-contracts.md (a fix that landed in the wrong media block); nothing to change (weekly review 23 Sep 26)
**Date:** 2026-08-25
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/docs/bug-check-order.md and OUTSTANDING.md [HUMAN-RETEST]; nothing to change (weekly review 23 Sep 26)
**Date:** 2026-08-26
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/docs/engine-rules.md §Weekend/PH work earns OIL (derives on read); nothing to change (weekly review 23 Sep 26)
**Date:** 2026-08-28
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/CLAUDE.md §Time format; nothing to change (weekly review 23 Sep 26)
**Date:** 2026-08-30
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/docs/performance.md §E Leave War (content-visibility); nothing to change (weekly review 23 Sep 26)
**Date:** 2026-09-01
...
**Status:** ACTIONED (2026-09-23) — Applied to impeccable project config: detector.ignoreFiles for the engine and test files (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-09-01
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/CLAUDE.md §How to work here (no auto-merge; "merge live"); nothing to change (weekly review 23 Sep 26)
**Date:** 2026-09-02
...
**Status:** ACTIONED (2026-09-23) — Applied to writing-plans: plan-file check, per-task browser check, Model line, standing orders, No-Placeholders items, self-review 4-9; the self-review now hands the same checks to an independent reviewer of the plan (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-09-02
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/docs/ui-contracts.md §Drag / arm-and-plant (root user-select baseline); nothing to change (weekly review 23 Sep 26)
**Date:** 2026-09-02
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/CLAUDE.md §Architecture rules (what actually persists); nothing to change (weekly review 23 Sep 26)
**Date:** 2026-09-04
...
**Status:** ACTIONED (2026-09-23) — Applied to systematic-debugging: reproduce / recent-change / working-example lines, the flaky block, device-only-bugs.md (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-09-02
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/docs/performance.md §The one law: measure first; nothing to change (weekly review 23 Sep 26)
**Date:** 2026-09-03
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/docs/performance.md §Dead ends; nothing to change (weekly review 23 Sep 26)
**Date:** 2026-09-04
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/docs/performance.md §D Drag and drop; nothing to change (weekly review 23 Sep 26)
**Date:** 2026-09-04
...
**Status:** ACTIONED (2026-09-23) — Applied to session-handoff + executing-plans: check-before-acting PR state, whole In-flight reconcile, Step 3 range fix, premise check (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-09-05
...
**Status:** ACTIONED (2026-09-23) — Applied to task-observer: numbering across branches, close-it-where-you-apply-it, review Step 3, the pinned log location, the second log folded in; its module-mock half is in test-driven-development/writing-good-tests.md (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-09-05
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/docs/performance.md ledger items 22-25; nothing to change (weekly review 23 Sep 26)
**Date:** 2026-09-05
...
**Status:** ACTIONED (2026-09-23) — Applied to using-git-worktrees: the symlinked-dependencies staging trap (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-09-05
...
**Status:** ACTIONED (2026-09-23) — already reflected in .claude/rules/plain-language.md (loaded every session); nothing to change (weekly review 23 Sep 26)
**Date:** 2026-09-05
...
**Status:** DECLINED (2026-09-23) — the owner retired the bug-testing list instead (D72); each change's bug check is recorded in its evidence sheet under raptor-port/docs/handpass/ (weekly review 23 Sep 26)
**Date:** 2026-09-05
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/docs/ui-contracts.md (compositor-layer section); nothing to change (weekly review 23 Sep 26)
**Date:** 2026-09-05
...
**Status:** ACTIONED (2026-09-23) — Applied to writing-plans: plan-file check, per-task browser check, Model line, standing orders, No-Placeholders items, self-review 4-9 (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-09-05
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/docs/ui-contracts.md (page stays usable behind a sheet); nothing to change (weekly review 23 Sep 26)
**Date:** 2026-09-06
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/CLAUDE.md §Product bar (state the expected time before the first task); nothing to change (weekly review 23 Sep 26)
**Date:** 2026-09-07
...
**Status:** ACTIONED (2026-09-23) — Applied to verification-before-completion: Common Failures rows / long-run pattern / browser-checks.md; its read-the-CI-result-after-each-push half is already in raptor-port/CLAUDE.md §How to work here (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-09-07
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/docs/performance.md §The perf gate (desktop and phone); nothing to change (weekly review 23 Sep 26)
**Date:** 7 Sep 26
...
**Status:** DECLINED (2026-09-23) — a one-off masking job; the standing rule (synthetic demo data, tripwire-tested) is in raptor-port/docs/architecture-direction.md §5, and the repo is private (D59) (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-09-09
...
**Status:** ACTIONED (2026-09-23) — Applied to writing-plans: plan-file check, per-task browser check, Model line, standing orders, No-Placeholders items, self-review 4-9; its compact-only-at-a-clean-point half is already in the owner's global instructions (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-09-10
...
**Status:** ACTIONED (2026-09-23) — Applied to machine-local memory notes: Windows exit code, per-section convergence, when not to commission a pre-build guide, quoting layers (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-09-13
...
**Status:** ACTIONED (2026-09-23) — already reflected in the machine-local memory note astra-codex-cli-available (runner command, --host mapping); nothing to change (weekly review 23 Sep 26)
**Date:** 2026-09-14
...
**Status:** DECLINED (2026-09-23) — a one-off parse error (`*/` inside a block comment); too narrow for a guide (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-09-18
...
**Status:** ACTIONED (2026-09-23) — already reflected in raptor-port/docs/bug-check-order.md §3 (the walk owns the seams); nothing to change (weekly review 23 Sep 26)
**Date:** 2026-09-21
...
**Status:** ACTIONED (2026-09-23) — Applied to task-observer: numbering across branches, close-it-where-you-apply-it, review Step 3, the pinned log location, the second log folded in (weekly review 23 Sep 26, owner-approved)
**Date:** 2026-09-23
...
## Checkpoint markers moved from the active log
