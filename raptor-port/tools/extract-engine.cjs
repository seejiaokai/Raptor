...
const OPTIONAL = { win: ['openEnd'], signPeople: ['keep'], markEdit: ['key'], slotBar: ['rules'], armSlot: ['el'], ted: ['tag'], plRow: ['rmkTxt'], paletteHTML: ['opts'], puck: [] };
...
const UI_MODS = {
  ...
  'html.ts': {
    ...
    ranges: [[2587, 2615], [2369, 2393], [3195, 3200], [3202, 3203], [3285, 3416], [3462, 3482], [4679, 4692], [4703, 4708], [3600, 3820], [5861, 5877], [3914, 3963]],
  },
};
