...
const B = [
  ...
  ['B10', 'Approve → On the roster: a person who already has an account is said so (Fable read #1)', 'src/ui/UsersPanel.tsx', '  if (acct) {', '  if (false && acct) {', [NPUI]],
  ...
  ['B28', 'Approve note: the account is checked before archived (both fix checks #1)', 'src/ui/UsersPanel.tsx', '  if (acct) {', '  if (acct && !p.archived) {', [NPUI]],
