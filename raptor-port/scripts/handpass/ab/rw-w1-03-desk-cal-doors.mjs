/* RE-WALK copy of w1-03-desk-cal-doors.mjs (26 Sep 26, the absence-record re-walk, W1): pictures go to docs/img/handpass/2026-09-26-absence/rewalk/w1/, results to docs/handpass/parts/2026-09-26-absence-rewalk-w1-*.txt; every change of premise or added check is marked RE-WALK. The first walk's script is untouched. */
...
const R = resultBook('W1-03-desk', `${ROOT}/docs/handpass/parts/2026-09-26-absence-rewalk-w1-03-desk.txt`)
