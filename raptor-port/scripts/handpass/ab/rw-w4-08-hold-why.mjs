/* W4 — FINDING W4-1 (26 Sep 26), written as the assertion of the RIGHT behaviour so re-running it is the re-walk:
   ...
   RE-WALK COPY (26 Sep 26, re-walker W4): pictures to rewalk/w4, results to the rewalk-w4-hold-why file. Beyond the
...
const R = L.resultBook('W4-1', `${L.ROOT}/docs/handpass/parts/2026-09-26-absence-rewalk-w4-hold-why.txt`)
