/* W4 probe (26 Sep 26): can a FINGER select ONE day on the war? A long-press held still and lifted, and holds with a
   ...
   RE-WALK COPY (26 Sep 26, re-walker W4): pictures to rewalk2/w4; each hold is now a check — the selection sheet must be
...
const R = L.resultBook('W4-hold-probe', `${L.ROOT}/docs/handpass/parts/2026-09-26-absence-rewalk2-w4-hold-probe.txt`)
