/* RW copy of w3-06-till.mjs for the re-walk (26 Sep 26, the rebuilt app): pictures to rewalk/w3, results to 2026-09-26-absence-rewalk-w3-*.txt. */
...
const R = resultBook('RW-W3-06', `${ROOT}/docs/handpass/parts/2026-09-26-absence-rewalk-w3-06.txt`)
