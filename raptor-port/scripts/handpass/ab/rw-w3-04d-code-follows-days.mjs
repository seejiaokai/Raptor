/* RW copy of w3-04d-code-follows-days.mjs for the re-walk (26 Sep 26, the rebuilt app): pictures to rewalk/w3, results to 2026-09-26-absence-rewalk-w3-*.txt. */
...
const PHONE = W === 'phone'
const R = resultBook(`RW-W3-04d-${W}`, `${ROOT}/docs/handpass/parts/2026-09-26-absence-rewalk-w3-04d-${W}.txt`)
