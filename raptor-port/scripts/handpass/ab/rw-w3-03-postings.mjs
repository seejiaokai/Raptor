/* RW copy of w3-03-postings.mjs (re-walk, 26 Sep 26): pictures to rewalk/w3, results to 2026-09-26-absence-rewalk-w3-03-<width>.txt. Checks unchanged — they were written as the RIGHT behaviour (AB5 said, W3-F5 the sheet stays). */
...
const PHONE = W === 'phone'
const R = resultBook(`RW-W3-03-${W}`, `${ROOT}/docs/handpass/parts/2026-09-26-absence-rewalk-w3-03-${W}.txt`)
