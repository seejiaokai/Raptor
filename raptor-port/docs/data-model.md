...
published schedule or `manual`) and **notices** — never approved leave, which
...
| `oil` | choice `auto\|manual` | credit only | `auto` = generated by the OIL pass (removable by it); `manual` = typed by an admin |
