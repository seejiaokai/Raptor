...
| **No amendment nobody made** | A day published before the app kept this record does not light up the moment the change ships. **TRUE OF A DAY THAT EARNS NOTHING. A published WEEKEND carrying a placeholder on a duty desk, a sim seat or an extras line DOES read "1 pending" — correctly, because republishing it would credit men the issued day never paid (D48) — and it SAYS SO rather than asking for an amendment it cannot explain.** **SETTLED, D54 (23 Sep 26): leave it.** He republishes once and those men get their OIL; silencing it would leave them unpaid for that seat. Do not "fix" the mark away. | step 9b; the sentence 22 Sep 26 | `engine/oilmembership.test.ts` |
