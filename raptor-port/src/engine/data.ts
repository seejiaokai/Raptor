...
export const DAYS:any[]=[
 {dow:'Monday',dt:'Jul 13',wc:'4 X 4 X 0',today:true,
  ...
  waves:[
   ...
   {label:'WAVE 2',night:true,intimes:['1900H: NIGHT WAVE VL IN TIME + WX/NOTAMS','1920H: NIGHT WAVE RU IN TIME + WX/NOTAMS'],traffic:[],formations:[
     ...
     {cs:'RU',msn:'BFM',to:'19:20',ld:'20:45',aircraft:[
       {p:'pump',w:'dirty',area:'WEST',rmks:'1A: NIGHT',opts:{tk2:true,tpod:false,nav:true,bombs:''}},
       {p:'casper',w:'shrek',area:'SOUTH',rmks:'2A: NIGHT BFM',opts:{tk2:false,tpod:false,nav:true,bombs:''}}]}]}],
  ...
  sims:{amt:[{label:'BRIEF',str:'1100',end:'',rmks:'ALL 8 PAX @ AMT BLDG'},
        ...
        oft:[{label:'EP-4',str:'0800',end:'0930',p:'haowen',w:'stiff',rmks:'A: IEPE / EP-3N // BRIEF 30 PRIOR'},{label:'EP-4',str:'1200',end:'1330',p:'bane',w:'snap',rmks:'A: SA(S)-3 // BRIEF 30 PRIOR'},{label:'SIMS (EXT SQN)',str:'1330',end:'1500',who:'EXT SQN',rmks:'EXT SQN SLOT'},{label:'EP-6',str:'1500',end:'1630',p:'prism',rmks:'B: SEFE'},
  ...
  waves:[
   {label:'WAVE 1',night:false,intimes:['0600H: FIRST WAVE VL IN TIME + WX/NOTAMS','0700H: FIRST WAVE RU IN TIME + WX/NOTAMS'],traffic:[],formations:[
     {cs:'VL',msn:'BFM',to:'08:40',ld:'10:05',aircraft:[
       {p:'nact',w:'glass',area:'EAST',rmks:'1B: BFM-3',opts:{tk2:true,tpod:true,nav:false,bombs:''}},
       {p:'casper',w:'rocky',area:'SOUTH',rmks:'2A: BFM-6',opts:{tk2:true,tpod:false,nav:false,bombs:''}}]},
   ...
   {label:'WAVE 2',night:false,intimes:['1200H: SECOND WAVE VL IN TIME + WX/NOTAMS','1300H: SECOND WAVE RU IN TIME + WX/NOTAMS'],traffic:[],formations:[
     ...
     {cs:'RU',msn:'ACM',to:'14:40',ld:'16:05',aircraft:[
       {p:'romeo',w:'ammo',area:'NORTH+EAST',rmks:'RED AIR',opts:{tk2:true,tpod:false,nav:false,bombs:''}},
       {p:'vegas',w:'cards',area:'SOUTH',rmks:'2A: ACM-2',opts:{tk2:true,tpod:false,nav:false,bombs:''}}]}]}],
  sims:{amt:[{label:'BRIEF',str:'1400',end:''},{label:'BOX',str:'1430',end:'1530'},{label:'DEBRIEF',str:'1530',end:''}],
        oft:[{label:'EP-5',str:'0930',end:'1100',p:'haowen',w:'freak'},{label:'SIMS (EXT SQN)',str:'1200',end:'1330',who:'EXT SQN'}]},
  ...
  waves:[
   ...
   {label:'WAVE 2',night:false,intimes:['1200H: SECOND WAVE VL IN TIME + WX/NOTAMS','1200H: SECOND WAVE RU IN TIME + WX/NOTAMS'],traffic:[],formations:[
     ...
     {cs:'RU',msn:'BFM',to:'13:00',ld:'14:25',aircraft:[
       {p:'vinci',w:'plasma',area:'NORTH+EAST',rmks:'PRI LSR',opts:{tk2:true,tpod:false,nav:false,bombs:''}},
       {p:'pike',w:'badger',area:'SOUTH',rmks:'2A: BFM-8',opts:{tk2:true,tpod:false,nav:false,bombs:''}}]}]}],
  ...
  waves:[
   ...
   {label:'WAVE 2',night:true,intimes:['1615H: NIGHT WAVE VL IN TIME + WX/NOTAMS','1615H: NIGHT WAVE RU IN TIME + WX/NOTAMS'],traffic:[],formations:[
     ...
     {cs:'RU',msn:'BFM',to:'16:45',ld:'18:10',aircraft:[
       {p:'bane',w:'rocky',area:'WEST',rmks:'1B: NIGHT',opts:{tk2:true,tpod:false,nav:true,bombs:''}},
       {p:'vinci',w:'drill',area:'SOUTH',rmks:'2A: BFM-8X / OC CHK',opts:{tk2:true,tpod:false,nav:true,bombs:''}}]}]}],
  sims:{amt:[{label:'BRIEF',str:'1100',end:''},{label:'BOX',str:'1130',end:'1230'},{label:'DEBRIEF',str:'1230',end:''}],
        oft:[{label:'EP-4',str:'0900',end:'1030',p:'haowen',w:'plasma'},{label:'SIMS (EXT SQN)',str:'1200',end:'1330',who:'EXT SQN'}]},
...
/* The pristine week-1 model, captured at module load BEFORE any iid mint or
   demo-SANS seeding, so the week selector can reload this week as a clean copy
