...
export function lgRules(){
  ...
  {g:'The standby lines',
   ...
   rows:[
    ...
    {sev:'set',src:()=>`scSpare`,
     t:()=>`An <b>SC SPARE</b> is standing by, not tasked: he is checked for <b>currency</b>, for being <b>able to stand it at all</b>, for the <b>front seat</b> — a WSO may not hold a spare front seat — and for <b>not holding another SC seat in the same hours</b>. Nothing else: he may fly, sit a sim or stand a duty in the same hours and none of it raises anything; but an overseas leave or a downchit across the shift does, and so does another SC seat — MAIN or SPARE — whose hours overlap his.<span class="why">Overlap means genuinely shared minutes: SC AM 07:00–13:00 into SC PM 13:00–19:00 touch only at 13:00 and stay two clean shifts a man may hold back to back (owner, 31 Aug 26). The crew picker refuses the second seat with the same rule the warning uses, so the two never disagree. The rear spare seat carries no seat rule — offered and declined the same day.</span>`},
