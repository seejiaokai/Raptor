...
export function installProbeBridge() {
  ...
  w.inputCoversDate = inputCoversDate; w.inpLabel = inpLabel; w.isOther = isOther; w.dateOrd = dateOrd; w.baseYear = baseYear
