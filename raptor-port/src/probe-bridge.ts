...
import { INPUTS, INPUT_TYPES, INPUT_META, TYPE_GROUPS, DATES, inpMeta, inpType, canSpare, canWork, awayAllDay, inpWin, typeGroup, isLeave, isLocalLeave, isDownchit, isOffType, isPersonal, isUnavail, isFly, isAway, isSansAvail, sansAvailOn, sansWindow, sansLetters, sansBadge, inputFlags, inputCoversDate, inpLabel, isOther, restsInput, dateOrd, baseYear, isLateInput, lateNote, inputDueISO, weekStartISO, inputStampISO } from './engine/inputs'
...
export function installProbeBridge() {
  ...
  w.inputCoversDate = inputCoversDate; w.inpLabel = inpLabel; w.isOther = isOther; w.restsInput = restsInput; w.dateOrd = dateOrd; w.baseYear = baseYear
