...
## The OIL tracker's credit boxes read in full — branch `claude/oil-credit-tags`, WAITING for his "merge live" (24 Sep 26)
...
**Pushed, NO pull request yet** — opening one starts the check run on his PC, and the demo has first call on it (D125);
open it when he says the PC is free, then read its checks before any merge. **Open question put to him:** the demo's
