...
- **RESOLVED 2 Sep 26 (Leave War OIL TRACKER + admin-set LVE BAL + OFF USED
  ...
  **SECOND CUT the same day (owner, after the mockup round + an
  ...
  boxes; idle people a 28px row. The per-person page is gone (Cinch OIL BAL
