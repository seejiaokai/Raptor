...
- **LEAVE WAR SPEED — PHASE 1 AND PHASE 2 SHIPPED (owner, 3 Sep 26 — "I'm
  ...
  **PHASE 2 — THE COLUMN WINDOW (`ui/colwindow.ts`, pure; the measuring and
  ...
  (d) The desktop bottom scrollbar spans the DRAWN months, not the year —
  the month strip is the year-level navigation now; a year-wide proxy
  scrubber is a possible follow-up if the owner misses the old thumb.
