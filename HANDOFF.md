...
| `components/` | Header (the File menu hidden while the file is locked; everything else drawn for every login; `#trUndoBtn`/`#trRedoBtn` — renamed from Raptor's ids — on the bar since 9 Sep 26), ArrangeTools, SidePanel, ShowAllPanel, Pop, Legend, Modals, ZoomControls — otherwise unchanged. |
