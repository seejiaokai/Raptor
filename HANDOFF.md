...
| gate | reading |
|---|---|
| `npm test` | 2475 across 137 files — two vitest projects: raptor 1716/101, leavewar 759/36 |
| `node reference/tfin.js` | 728/0 (the reference is read-only) |
| `npm run build` | clean |
| `npm run test:e2e` | 258 passed / 6 touch-only skips — three playwright projects: raptor geometry, lw-phone, lw-desktop |
| `probes:adapted` | 6/6 |
| `perf` | 4/4 |
